        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={styles.opportuniteItem}>
              ...
              >
                <Text>
                  <Text style={{ fontWeight: 'bold' }}>{item.compte?item.compte.raisonSociale:''}</Text> {item.nature?item.nature.code:''}{' '}
                  {item.type.code} {item.id}
                </Text>
                <View style={styles.avatarContainer}>
                  <Text style={styles.avatarText}>{item.owner?item.owner.nomComplet.charAt(0):''}</Text>
                </View>
              </View>
            </View>
          )}
